const InputName = ({ name, setName, setUserName }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-bl from-violet-500 via-fuchsia-500 to-yellow-200 dark:from-purple-900 dark:via-pink-800 dark:to-red-900 transition-colors duration-500 p-6">
      <div className="bg-white/80 dark:bg-gray-900/80 rounded-2xl shadow-lg p-8 max-w-md w-full text-center backdrop-blur-lg border border-gray-200 dark:border-gray-700 transform transition-all duration-300 hover:shadow-2xl hover:scale-[1.02]">
        <h1 className="text-2xl font-bold mb-6 text-gray-800 dark:text-gray-100">Masukkan Nama Anda</h1>
        <form
        ...
        >
          <input
            ...
            placeholder="Tuliskan nama di sini..."
